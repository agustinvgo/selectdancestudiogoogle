        ...
        <div className="space-y-6">
            ...
            {estado === 'esperando' && (
                <div className="rounded-2xl border border-amber-200 bg-amber-50 p-10 text-center">
                    ...
                    <h3 className="text-lg font-bold text-gray-900 mb-1">La clase está por comenzar</h3>
                    <p className="text-gray-600 text-sm">
                        {data.curso?.nombre} está en horario. Esperando que arranque la transmisión…
                    </p>
                </div>
            )}

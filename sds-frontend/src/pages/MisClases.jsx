            ...
            {cursos.length === 0 ? (
                <div className="card">
                    <div className="card-body text-center py-12">
                        ...
                        <p className="text-gray-400 text-lg">No tienes clases inscritas</p>
                        ...
                        <div key={curso.id} className="card hover:border-sds-red transition-all">
                            <div className="card-body">
                                <div className="mb-4">
                                    ...
                                    {curso.descripcion && (
                                        <p className="text-sm text-gray-400 mt-2">{curso.descripcion}</p>
                                    )}
                                </div>
                                ...
                                <div className="space-y-3">
                                    ...
                                    {curso.profesor && (
                                        <div className="pt-3 border-t border-gray-700">
                                            ...
                                            <p className="text-white font-medium">{curso.profesor}</p>
                                        </div>
                                    )}
                                </div>
                            </div>
                            ...
                            {['Lunes', 'Martes', 'Miércoles', 'Jueves', 'Viernes', 'Sábado', 'Domingo'].map((dia) => {
                                ...
                                return (
                                    <div key={dia} className="space-y-2">
                                        <h4 className="font-semibold text-white text-sm border-b border-gray-700 pb-2">
                                            {dia}
                                        </h4>
                                        {clasesDelDia.length > 0 ? (
                                            clasesDelDia.map((curso) => (
                                                <div key={curso.id} className="p-2 bg-gray-900 rounded text-xs">
                                                    <p className="font-medium text-white">{curso.nombre}</p>
                                                    <p className="text-gray-400 mt-1">
                                            ...
                                            <p className="text-gray-600 text-xs italic">Sin clases</p>
                                        )}
                                    </div>
                                );
                            })}

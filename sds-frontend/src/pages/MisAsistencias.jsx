...
const MisAsistencias = () => {
    ...
    }, [alumnoId, mesSeleccionado, anioSeleccionado]);
    ...
    const cargarAsistencias = async () => {
        try {
            ...
            const response = await asistenciasAPI.getByAlumno(alumnoId, mesSeleccionado, anioSeleccionado);
    ...
    if (!esAlumno) {
        return (
            <div className="space-y-6">
                <div>
                    <h1 className="text-3xl font-bold text-white">Mis Asistencias</h1>
                    <p className="text-gray-400 mt-1">Historial de asistencia a clases</p>
                </div>
                <div className="card">
                    <div className="card-body text-center py-12">
                        <p className="text-gray-400 text-lg">Esta sección es solo para alumnos.</p>
            ...
            <div className="grid grid-cols-1 md:grid-cols-4 gap-6">
                <div className="card">
                    <div className="card-body">
                        <p className="text-sm text-gray-400">Total de Clases</p>
            ...
            <div className="card">
                <div className="card-body">
                    <div className="flex items-center justify-between mb-2">
                        ...
                        <span className="text-sm font-bold text-white">{porcentaje.toFixed(1)}%</span>
                    </div>
                            ...
                            <table className="table">
                                ...
                                <tbody>
                                    {asistencias.map((asist, index) => {
                                        ...
                                        return (
                                            <tr key={key}>
                                                <td className="font-medium text-white">{fecha}</td>
                                                <td className="text-gray-300">{curso}</td>
                                                <td>
                                                    {presente ? (
                                                ...
                                                <td className="text-gray-400 text-sm">{obs}</td>
                                            </tr>
                                        );
                                    })}
                                </tbody>

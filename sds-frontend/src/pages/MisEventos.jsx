            ...
            {eventos.length === 0 ? (
                <div className="card">
                    <div className="card-body text-center py-12">
                        ...
                        <p className="text-gray-400 text-lg">No tienes eventos inscritos</p>
                                        ...
                                        <div className="card-body">
                                            <div className="flex items-start justify-between mb-4">
                                                <div className="flex-1">
                                                    ...
                                                    {evento.descripcion && (
                                                        <p className="text-gray-400 mt-2">{evento.descripcion}</p>
                                                    )}
                                                </div>
                                            ...
                                            <div className="border-t border-gray-700 pt-4">
                                                <h4 className="font-semibold text-white mb-3">📋 Checklist de Preparación</h4>
                                                <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                                                    <div className={`p-3 rounded-lg ${evento.checklist_vestuario ? 'bg-green-900/20 border border-green-900' : 'bg-gray-900'}`}>
                                                        <div className="flex items-center justify-between mb-2">
                                                            <span className="text-sm font-medium text-white">👗 Vestuario</span>
                                                        ...
                                                        {evento.vestuario_requerido && (
                                                            <p className="text-xs text-gray-400 mt-1">{evento.vestuario_requerido}</p>
                                                        )}
                                                    </div>

                                                    <div className={`p-3 rounded-lg ${evento.checklist_peinado ? 'bg-green-900/20 border border-green-900' : 'bg-gray-900'}`}>
                                                        <div className="flex items-center justify-between mb-2">
                                                            <span className="text-sm font-medium text-white">💇 Peinado</span>
                                                        ...
                                                        {evento.peinado_instrucciones && (
                                                            <p className="text-xs text-gray-400 mt-1">{evento.peinado_instrucciones}</p>
                                                        )}
                                                    </div>

                                                    <div className={`p-3 rounded-lg ${evento.checklist_maquillaje ? 'bg-green-900/20 border border-green-900' : 'bg-gray-900'}`}>
                                                        <div className="flex items-center justify-between mb-2">
                                                            <span className="text-sm font-medium text-white">💄 Maquillaje</span>
                                                        ...
                                                        {evento.maquillaje_instrucciones && (
                                                            <p className="text-xs text-gray-400 mt-1">{evento.maquillaje_instrucciones}</p>
                                                        )}
                                                    </div>
                                                </div>
                                            </div>
